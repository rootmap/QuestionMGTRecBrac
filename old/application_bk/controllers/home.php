...
<div style=" text-align:center; border:1px #000 solid;">
   ...
   <ul style="font-size: 10px;font-family: "Franklin Gothic Medium", "Franklin Gothic", "ITC Franklin Gothic", Arial, sans-serif;">
      <li>1. The Admit Card must be presented for verification in the exam venue along with at least one original (not photocopy or scanned copy) valid photo identification proof (Example: NID, Smart Card, Passport)</li>
      <li>2. This admit card is valid only if the candidates photograph and signature images are readable. To ensure this, please take a clear print out (preferably color printout) of the admit card in A4 sized paper. </li>
      <li>3. Candidates must report at the examination venue minimum <b> 30 minutes </b> before scheduled start of the examination. </li>
      <li>4. Candidates will be permitted to appear for the examination only after their credentials are verified by Centre officials.</li>
      <li>5. Candidates will be permitted to occupy their allocated seats <b>20 minutes</b> before the scheduled start of the examination. </li>
      <li>6. In case of <b>ONLINE EXAMINATION</b>, candidates can login and start reading the necessary instructions <b>15 minutes</b> before start of the examination. The automated timer will start counting the time, the moment you enter the examination. The examination will close automatically when the time runs out. You must submit the answers before the time expires. </li>
      <li>7. In case of <b>WRITTEN EXAMINATION</b>, you can be provided with OMR based answer scripts to mark your answers. You are requested to fill out the form carefully and not to fold the OMR Sheet or attach anything with it. To answer all the questions, use black ball pen only. </li>
      <li>8. Candidates will not be permitted to leave the examination hall prior the examination ends or
         instructed by the invigilator to do so.
      </li>
      <li>9. Personal calculator, Mobile Phones or any other electronic devices are not allowed un the examination hall. Candidates should not bring any additional documents into the examination hall. BRAC Bank authority will not be responsible for safe keeping of candidate’s personal belongings.</li>
   </ul>
   </div>
    ...
    private function generate_survey_html($list)
    {
        ...
        if (count($list) > 0) {
            ...
            for ($i=0; $i<count($list); $i++) {
                ...
                if($blink_text. $list[$i]->status=="open")
                {
