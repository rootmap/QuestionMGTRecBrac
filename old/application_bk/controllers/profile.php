...
class Profile extends MY_Controller
{
    ...
    public function change_password()
    {
        ...
        if ($this->user_model->change_password($this->logged_in_user->id, $old_password, $new_password, $confirm_password, true)) {
            ...
            $this->session->set_flashdata('message_success', 'You have successfully changed your password.<script>setTimeout(function(){ window.location.href="'.site_url('/home').'"; }, 2000);</script>');
