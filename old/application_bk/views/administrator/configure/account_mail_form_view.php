...
<h3 class="heading"><?php if($is_edit) echo 'Edit'; else echo ''; ?> Account Creation Mail Layout</h3>
...
<?php echo form_open('administrator/'.$view_controller.'/update_account_mail_layout', array('class' => 'form-horizontal')); ?>
    ...
    <div class="control-group formSep">
        ...
        <div class="controls" id="body-control">
            <textarea name="cat_layout" id="cat_layout" rows="5" cols="30"><?php
                    if(!isset($this->form_data->account_mail_layout))
                    {
                        $this->form_data->account_mail_layout='';
                    }
                    echo set_value('cat_layout', $this->form_data->account_mail_layout); ?></textarea>
