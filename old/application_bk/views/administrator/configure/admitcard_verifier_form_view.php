...
<h3 class="heading"><?php if($is_edit) echo 'Edit'; else echo 'Add New'; ?> Admit Card Verifier Layout</h3>
...
<?php if ( ! $is_edit) : ?>
<?php echo form_open('administrator/'.$view_controller.'/add_admitcardlayout', array('class' => 'form-horizontal')); ?>
<?php else : ?>
<?php echo form_open('administrator/'.$view_controller.'/update_admitcardlayout', array('class' => 'form-horizontal')); ?>
<?php endif; ?>
