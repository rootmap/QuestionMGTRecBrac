...
<?php echo form_open_multipart('administrator/survey_question/edit_bulk_upload_do_action', array('class' => 'form-horizontal')); ?>

    <?php if ($bulk_questions_count > 0) : ?>
    <div class="alert alert-success"><?php echo $bulk_questions_count; ?> records found to be valid and can be updated. Press the 'Update Bulk Questions' button below to update valid questions.</div>
    <?php endif; ?>
    ...
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <?php if ($bulk_questions_count > 0) : ?>
            <input type="submit" name="update_bulk_questions" value="Update Bulk Questions" class="btn btn-primary btn-large" />&nbsp;&nbsp;
            <?php endif; ?>
            ...
            <a href="<?php echo base_url('administrator/question/edit_bulk'); ?>" class="btn btn-large">Upload File Again</a>&nbsp;&nbsp;
