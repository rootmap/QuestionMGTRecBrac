...
<?php echo form_open_multipart('administrator/user/delete_bulk_upload_do_action', array('class' => 'form-horizontal')); ?>

    <?php if ($bulk_users_count > 0) : ?>
    <div class="alert alert-success"><?php echo $bulk_users_count; ?> records found to be valid and can be deleted. Press the 'Delete Bulk Users' button below to delete valid users.</div>
    <?php endif; ?>
    ...
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <?php if ($bulk_users_count > 0) : ?>
            <input type="submit" name="delete_bulk_users" value="Delete Bulk Users" class="btn btn-primary btn-large" />&nbsp;&nbsp;
            <?php endif; ?>
            ...
            <a href="<?php echo base_url('administrator/user/delete_bulk'); ?>" class="btn btn-large">Upload File Again</a>&nbsp;&nbsp;
