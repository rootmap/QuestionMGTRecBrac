...
<h1 class="heading">Add Bulk Users</h1>
...
<?php echo form_open_multipart('administrator/user/bulk_upload', array('class' => 'form-horizontal')); ?>

    <div class="alert">
        Upload an Excel file to import users into the system. <br />
