        ...
        <div class="control-group formSep">
            ...
            <div class="controls">
                <div class="input-append">
                    <?php echo form_dropdown('question_ids[]', $this->question_list, @$this->form_data->question_ids, 'id="question_ids" multiple="multiple" class="chosen-select input-xxlarge"'); ?>
                </div>
            </div>
        </div>
