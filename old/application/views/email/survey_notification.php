<?php
if ($site_name == '') {
    $site_name = 'Robi Tothya Shombhar';
}
...
$start_time = date('jS F, Y \a\t g:i a', strtotime($user_survey->start_date));
$end_time = date('jS F, Y \a\t g:i a', strtotime($user_survey->end_date));
        ...
        <td width="660" valign="top">
            ...
            <tr><td>
            	...
            	<font style="color:#333333;font-size:14px;line-height:18px;font-family:Arial,Helvetica,sans-serif;" color="#333333">
                    ...
                    You have been assigned to take a survey titled, <strong>
                    <?php
                        echo $survey_name;
                    ?>
                    </strong>. The survey will
                    ...
                    You are requested to take the survey within specified time.<br /><br />
