...
function addNewChoice(text) {
    ...
    choiceHtml += '<div class="choice">';
        ...
        choiceHtml += '</div>';
        choiceHtml += '<textarea name="mcq_options[]" rows="3" cols="30" style="width:70%;">'+ text +'</textarea><input type="" name="mcq_marks[]" rows="3" cols="30" style="width:20%; height: 63px;font-size: 2em; font-weight: bolder;"/>';
    choiceHtml += '</div>';
