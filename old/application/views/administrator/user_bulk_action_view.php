...
<?php echo form_open_multipart('administrator/user/bulk_upload_do_action', array('class' => 'form-horizontal')); ?>

    <?php if ($bulk_users_count > 0) : ?>
    <div class="alert alert-success"><?php echo $bulk_users_count; ?> records found to be valid and can be imported. Press the 'Insert Bulk Users' button below to insert valid users.</div>
    <?php endif; ?>
    ...
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <?php if ($bulk_users_count > 0) : ?>
            <input type="submit" name="insert_bulk_users" value="Insert Bulk Users" class="btn btn-primary btn-large" />&nbsp;&nbsp;
            <?php endif; ?>
            ...
            <a href="<?php echo base_url('administrator/user/bulk'); ?>" class="btn btn-large">Upload File Again</a>&nbsp;&nbsp;
