...
<h1 class="heading">Add Bulk Questions</h1>
...
<?php echo form_open_multipart('administrator/survey_question/bulk_upload', array('class' => 'form-horizontal')); ?>

<div class="alert">
    Upload an Excel file to import survey questions into the system. <br />
    Uploaded excel file's columns should match with defined format.
    <a href="<?php echo base_url('download'); ?>/bulk-survey-question-import-example.xls" target="_blank">Click here</a>
