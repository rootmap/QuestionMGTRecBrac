...
<h1 class="heading">Edit Bulk Candidates</h1>
...
<?php echo form_open_multipart('administrator/candidate/edit_bulk_upload', array('class' => 'form-horizontal')); ?>

<div class="alert">
    Upload an Excel file to edit candidates from the system. <br />
    Uploaded excel file's columns should match with defined format.
    <a href="<?php echo base_url('download'); ?>/bulk-candidate-import-example.xls" target="_blank">Click here</a>
