    ...
    public function index()
    {
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '7' => array('data'=> 'Point'),
                '8' => array('data'=> 'Score %'),
                '9' => array('data'=> 'Competency level'),
                '10' => array('data'=> 'Start Time'),
                '11' => array('data'=> 'End Time'),
                '12' => array('data'=> '', 'class' => 'center')
            );
            ...
            for ($i = 0; $i<count($records_paged); $i++) {
                ...
                $tbl_row = array(
                    ...
                    '8' => array('data'=> $user_score_percent),
                    '9' => array('data'=> $competency_level),
                    '10' => array('data'=> $result_start_time),
                    '11' => array('data'=> $result_end_time),
                    '12' => array('data'=> $action_str, 'class' => 'center', 'width' => '50px')
                );
