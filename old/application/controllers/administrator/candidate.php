...
class Candidate extends MY_Controller
{
    ...
    public function index()
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Manage Candidate View'));
        ...
        if ($records) {
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $candidate_name = trim($records[$i]->user_first_name.' '.$records[$i]->user_last_name);
                $action_str='';
                $status='';
                if($records[$i]->user_is_active==1 )
                {
                    if(!isSystemAuditor())
                    $status=anchor('administrator/candidate/change_status/'. $records[$i]->id.'/'.$records[$i]->user_is_active, 'Active', array('title'=>'Change Status','class'=>'btn btn-success'));
                    else
                        $status = 'Active';
                }
                else{
                    if(!isSystemAuditor())
                    $status=anchor('administrator/candidate/change_status/'. $records[$i]->id.'/'.$records[$i]->user_is_active, 'Inactive', array('title'=>'Change Status','class'=>'btn btn-warning'));
                    else
                        $status= 'Inactive';
                }
                if(!isSystemAuditor())
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add New Candidate View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add New Candidate'));
        $page_info['title'] = 'Add New Candidate'. $this->site_name;
        $page_info['view_page'] = 'administrator/candidate_form_view';
        $page_info['message_error'] = '';
        $page_info['message_success'] = '';
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Change candidate status'));
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add Bulk Candidate View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Bulk Candidate View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Delete Bulk Candidate View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add Bulk Candidate'));
        $candidates = array();
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Bulk Candidate'));
        $candidates = array();
        $invalid_candidates = array();
        $error_messages = array();
        $file_path = '';
    ...
    public function download_candidate(){
        ...
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Download Candidate'));
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Delete Bulk Candidate'));
        $candidates = array();
        $invalid_candidates = array();
        $error_messages = array();
        $file_path = '';
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Candidate View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Update Candidate'));
        // set page specific variables
        $page_info['title'] = 'Edit candidate'. $this->site_name;
        $page_info['view_page'] = 'administrator/candidate_form_view';
        $page_info['message_error'] = '';
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Delete Candidate'));
        $candidate_id = (int)$this->uri->segment(4);
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Deactivate Candidate'));
        $candidate_id = (int)$this->uri->segment(4);
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Activate Candidate'));
        $candidate_id = (int)$this->uri->segment(4);
