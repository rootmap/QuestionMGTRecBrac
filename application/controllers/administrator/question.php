...
class Question extends MY_Controller
{
    ...
    public function index()
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Manage Question - List'));
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '8' => array(
                             'data'=> 'Bulk Status Change 
                                                    <br /> 
                                       <input type="checkbox" id="aprall" name="aprall" class="aprall">', 
                             'class' => 'center', 'width' => '120'),                
                '9' => array('data'=> 'Created By', 'class' => 'center', 'width' => '80'),
                '10' => array('data'=> 'Action', 'class' => 'center', 'width' => '50')
            );
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                //print_r($records[$i]); die();
                 $selectact = '';
                    $selectact .= '<input type="checkbox" name="approve_ques[]"   class="form-control input-sm"  data-name="'.$records[$i]->status.'" id="approval_cam" class="approve_ques" value="'.$records[$i]->id.'">';
                ...
                if ($records[$i]->ques_expiry_date != '' && $records[$i]->ques_expiry_date != '0000-00-00 00:00:00' && $records[$i]->ques_expiry_date <= date('Y-m-d H:i:s')) {
                    $expired_str = '<span class="label label-important">EXPIRED ('.date('d-m-Y',strtotime($records[$i]->ques_expiry_date)).')</span>';
                }
                ...
                $tbl_row = array(
                    ...
                    '1' => array('data'=> html_entity_decode($records[$i]->ques_text), 'min-width' => '30%'),
                    ...
                    '8' => array('data'=> $selectact, 'class' => 'center', 'width' => '50'),                    
                    '9' => array('data'=>$records[$i]->created_by_name, 'class' => 'center', 'width' => '50'),
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Question Statistics View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add New Question View'));
        // set page specific variables
    ...
    { //question updaed
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add Question'));
        $page_info['title'] = 'Add New Question'. $this->site_name;
        $page_info['view_page'] = 'administrator/question_form_view';
        $page_info['message_error'] = '';
        $page_info['message_success'] = '';
       ...
       // print_r_pre($t->id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $mark = intval($this->input->post('marks'));
            $neg_marks = intval($this->input->post('neg_marks'));
            ...
            { 
                $mark=0; 
                $this->session->set_flashdata('message_error', 'Please use without (-) negative sign in marking.');
                redirect('administrator/question/add');
            }

            if(substr($neg_marks,0,1)=='-')
            { 
                $neg_marks=0;
                $this->session->set_flashdata('message_error', 'Please use without (-) negative sign in marking.');
                redirect('administrator/question/add');
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Change All Question Status'));
        ...
        foreach ($value as $key => $value) {
         ...
         if($value)
         {
            ...
            if($this->update_global_model->update_batch('exm_questions','id',$update_data)){
    ...
    public function change_all_status_pending()
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Change All Pending Question Status'));
    ...
    public function change_all_status_approve()
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Change All Approved Question Status'));
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Add Bulk Question View'));
        // set page specific variables
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Question Bulk Upload'));
        $questions = array();
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Question View'));
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Question'));
        // set page specific variables
        $page_info['title'] = 'Edit Question'. $this->site_name;
        $page_info['view_page'] = 'administrator/question_form_view';
        $page_info['message_error'] = '';
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Bulk Question View'));
        // set page specific variables
    ...
    public function edit_bulk_upload()
    {
        ...
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Edit Question Bulk Upload'));
        $questions = array();
        $invalid_questions = array();
        $error_messages = array();
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Manage Questions (Pending)'));
        // set page specific variables
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '6' => array('data'=> 'Is Expired?', 'class' => 'center', 'width' => '80'),
                '7' => array('data'=> 'Status', 'class' => 'center', 'width' => '120'),
                '8' => array('data'=> 'Bulk Status Change 
                                                    <br /> 
                                       <input type="checkbox" id="aprall" name="aprall" class="aprall">', 'class' => 'center', 'width' => '120'),
                '9' => array('data'=> 'Created By', 'class' => 'center', 'width' => '80'),
                '10' => array('data'=> 'Action', 'class' => 'center', 'width' => '50')
            );
            $this->table->set_heading($tbl_heading);
    ...
    {
        $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Manage Questions (Approve)'));
        // set page specific variables
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '8' => array('data'=> 'Bulk Status Change 
                                                    <br /> 
                                       <input type="checkbox" id="aprall" name="aprall" class="aprall">', 'class' => 'center', 'width' => '80'),
                '9' => array('data'=> 'Created By', 'class' => 'center', 'width' => '80'),
                '10' => array('data'=> 'Action', 'class' => 'center', 'width' => '50')
            );
            $this->table->set_heading($tbl_heading);
    ...
    {
         $update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Manage Questions (Rejected)'));
        // set page specific variables
