...
<?php echo form_open_multipart('administrator/candidate/edit_bulk_upload_do_action', array('class' => 'form-horizontal')); ?>

<?php if ($bulk_candidates_count > 0) : ?>
    <div class="alert alert-success"><?php echo $bulk_candidates_count; ?> records found to be valid and can be imported. Press the 'Update Bulk candidates' button below to update valid candidates.</div>
<?php endif; ?>
...
<fieldset>
    ...
    <div class="form-actions">
        ...
        <?php if ($bulk_candidates_count > 0) : ?>
            <input type="submit" name="update_bulk_candidates" value="Update Bulk candidates" class="btn btn-primary btn-large" />&nbsp;&nbsp;
        <?php endif; ?>
        ...
        <a href="<?php echo base_url('administrator/candidate/edit_bulk'); ?>" class="btn btn-large">Upload File Again</a>&nbsp;&nbsp;
