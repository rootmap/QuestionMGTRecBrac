...
<h1 class="heading">Delete Bulk Users</h1>
...
<?php echo form_open_multipart('administrator/user/delete_bulk_upload', array('class' => 'form-horizontal')); ?>

    <div class="alert">
        Upload an Excel file to delete users from the system. <br />
        Uploaded excel file's columns should match with defined format.
        <a href="<?php echo base_url('download'); ?>/delete-bulk-user-import-example.xls" target="_blank">Click here</a>
    ...
    <fieldset>
        ...
        <div class="form-actions">
            <input type="submit" value="Upload and Bulk Delete" class="btn btn-primary btn-large" />&nbsp;&nbsp;
        </div>
