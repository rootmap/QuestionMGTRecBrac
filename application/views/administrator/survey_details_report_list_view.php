...
<h1 class="heading">Survey Detail Reports</h1>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="row control-row control-row-top">
            ...
            <?php echo form_open('administrator/survey_details_report/filter', array('class' => 'form-inline', 'id' => 'filter-form')); ?>
            ...
            <div class="span2">
                <?php if ($records && count($records) > 0): ?>
                    <?php echo form_open('administrator/survey_details_report/export_data'); ?>
