...
class Survey_model extends CI_Model
{
    ...
    public function get_paged_surveys($limit, $offset = 0, $filter = array())
    {
        ...
        $this->db->join('exm_users', 'exm_users.id = exm_surveys.user_employee', 'left');
        //$this->db->limit();
    ...
    public function get_user_survey_by_survey_paged($survey_id = 0, $start = '', $end = '', $limit = 50, $offset = 0, $filter = array())
    {
        ...
        $date_where = '';
            ...
            $this->db->select("TA.id AS user_survey_id,user_id, survey_id, start_date, end_date, completed, status, group_id,user_login, user_first_name, user_last_name, user_email, group_name,is_approved");
